/*
 * Modified to work with new registry key location
 */
...
namespace DirectOutputCSharpWrapper {
	...
	public class RegistryKeyNotFound : Exception {
		public RegistryKeyNotFound() : base(@"HKEY_LOCAL_MACHINE\SOFTWARE\Logitech\DirectOutput key not found.") {}
	}

	public class RegistryValueNotFound : Exception {
		public RegistryValueNotFound() : base(@"DirectOutput value in key HKEY_LOCAL_MACHINE\SOFTWARE\Logitech\DirectOutput not found.") {}
	}
